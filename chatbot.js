(function() {
    ...
    const MENU_DATA = {
        ...
        manashos: {
            ...
            options: [
                ...
                { id: 'os_games', label: "31 Games", icon: 'play' },
        ...
        projects: {
            ...
            options: [
                ...
                { id: 'proj_paath', label: "PaathSohayok", icon: 'book' },
    ...
    const CONTENT_ANSWERS = {
        ...
        os_games: "The platform hosts 31 interactive games and micro-challenges, including the new 21 Days Challenge, designed to test typing speed, memory, and cognitive logic.",
